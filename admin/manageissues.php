...
?>
	...
	<head>
		<title>Touristiva | Admin manage Issues</title>
									...
									if ($query->rowCount() > 0) {
										foreach ($results as $result) {				?>
											<tr>
												...
												<td><a href="javascript:void(0);" onClick="popUpWindow('http://localhost/Touristiva/admin/updateissue.php?iid=<?php echo ($result->id); ?>');">View </a>
												</td>
